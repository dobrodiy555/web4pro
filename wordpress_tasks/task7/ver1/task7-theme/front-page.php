<!--this is a homepage (analogue of index.htm) ->
...
<section id="content">
  <div class="wrapper page_text page_home">
    ...
    <div class="portfolio">
      <p class="all_projects"><a href="http://localhost/wordpress/portfolios/">View all projects</a></p>
      <h1>Portfolio</h1>
      <div class="columns">
        <div class="column column25">
          <a href="./gfx/examples/img_big8.jpg" class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
									<img src="<?php echo get_template_directory_uri(); ?>/gfx/examples/content_image197x140.jpg" alt="" />
        ...
        <div class="column column25">
          <a href="./gfx/examples/img_big2.jpg" class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
									<img src="<?php echo get_template_directory_uri(); ?>/gfx/examples/content_image197x140_2.jpg" alt="" />
									<span class="caption">Rhoncus, dolor id rutrum ut.</span>
								</span>
            <span class="image_shadow"></span>
          </a>
        ...
        <div class="column column25">
          <a href="./gfx/examples/img_big7.jpg" class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
									<img src="<?php echo get_template_directory_uri(); ?>/gfx/examples/content_image197x140_3.jpg" alt="" />
									<span class="caption">Rhoncus, dolor id rutrum ut.</span>
								</span>
            <span class="image_shadow"></span>
          </a>
        ...
        <div class="column column25">
          <a href="./gfx/examples/img_big4.jpg" class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
									<img src="<?php echo get_template_directory_uri(); ?>/gfx/examples/content_image197x140_4.jpg" alt="" />
									<span class="caption">Rhoncus, dolor id rutrum ut.</span>
								</span>
            <span class="image_shadow"></span>
          </a>
