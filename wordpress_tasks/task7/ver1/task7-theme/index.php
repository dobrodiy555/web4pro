    ...
    <div class="wrapper page_text page_home">
      ...
      <div class="portfolio">
        ...
        <div class="columns">
          ...
          <div class="column column25">
            <a href="<?php echo get_template_directory_uri(); ?>/gfx/examples/img_big7.jpg" class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
          ...
          <div class="column column25">
            <a href="<?php echo get_template_directory_uri(); ?>/gfx/examples/img_big4.jpg" class="image lightbox" data-rel="prettyPhoto[gallery]">
								<span class="inside">
