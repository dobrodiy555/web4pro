...
add_action( 'wp_enqueue_scripts', 'include_my_script' );
...
function include_my_script() {
    wp_register_script( 'google_maps_api', 'https://maps.googleapis.com/maps/api/js?key={myKey}&callback=initMap', null, null, true );
	wp_enqueue_script( 'my_script', plugins_url( '/js/script.js', __FILE__ ), array( 'google_maps_api'), null, true );
