...
// translation of plugin name and description
$tp5_name = __( 'task5_plugin', 'tp5' );
$tp5_desc = __( 'This plugin adds custom field "Additional info" into checkout page WooCommerse. It will also be in emails and in admin panel of order', 'tp5' );
