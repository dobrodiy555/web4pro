...
<head>
    ...
    <style>
        ...
        #autocomplete_button {
            ...
            left: 578px;  /* выталкиваем от левой стороны */
            top: 127px; /* выталкиваем от верха */
        }
...
<script>
    ...
    // вызов ф-ции подргузки записей loadmore
    ...
    $("#loadform").submit(function(e) {  // при нажатии на кнопку loadmore
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $(".from_autocomplete").hide(); // прячем все старые записи вызванные на этой странице
                $(".from_date").hide();
    ...
    $("#description_form").submit(function(e) {
        ...
        // alert(myData);
        $(".from_description").hide(); // старые записи этой ф-ции спрячь
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#responds").append(response);
                $(".from_display").hide();  // скрываем все данные вызванные в univ_func1 ранее
                $(".from_loadmore").hide();
    ...
    $(function() {
        $("#autocomplete_search").autocomplete({
            source: 'find_title_autocomplete_to_make_it_work.php',
